...
#'
#' module.score<-calculate.module.score(graph = net.graph, nodes = module.nodes,
#' data = data, phenotype = qmdiab.phenos$T2D)
calculate.module.score<-function(graph, nodes, data, phenotype, covars=NULL,
  ...
  repdata<-calculate.module.representatives(data, representative.method)
