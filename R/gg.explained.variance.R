...
#'
#'
#' @param subnet a list generated by the \code{\link{create.pathways.network}} function
#' @import ggplot2
#' @import data.table
#' @export
#' @examples
#' pathway.graph<-create.pathways.network(data = qmdiab.data,
#'  annotations = qmdiab.annos, column.name = "Sub.pathway")
